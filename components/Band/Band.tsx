...
export const Band = ({ heading, items = [] }: BandProps) => {
  ...
  useEffect(() => {
    ...
    const members = Array.from(containerRef.current.querySelectorAll<HTMLElement>("[data-anim-item]"));
  ...
  return (
    <Section classNames={{ main: styles.main }} heading={heading} size="full" animationID="gallery-grid">
