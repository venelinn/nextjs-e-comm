...
const ContentSection: React.FC<{
  ...
  <div ref={innerRef as any} data-anim="content-image" className={styles.module__content}>
    {heading?.heading && (
...
export const ImageContent: React.FC<{
  ...
  id?: string;
}> = ({ heading, subHeading, animationID, theme, image, content, fullHeight, isolation, isContentFirst, id }) => {
  ...
  return (
    <Section animationID={animationID} height={fullHeight ? "full" : undefined} id={id}>
      <div
